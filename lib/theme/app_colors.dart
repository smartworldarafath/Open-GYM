...
class GymColors extends ThemeExtension<GymColors> {
  ...
  static GymColors darkWith([String uiColor = 'default']) => switch (uiColor) {
        'violet' => dark.copyWith(
            pageBg: const Color(0xFF0C0A10),
            bg: const Color(0xFF0F0D14),
            bgRaised: const Color(0xFF1D1926),
            bgRaised2: const Color(0xFF2C263A),
            border: const Color(0xFF3F3752),
            navBg: const Color(0xD90F0D14),
            accent: const Color(0xFFB388FF),
            accentSoft: const Color(0x29B388FF),
            brass: const Color(0xFFCE93D8),
          ),
        'green' => dark.copyWith(
            pageBg: const Color(0xFF080D0A),
            bg: const Color(0xFF0B110D),
            bgRaised: const Color(0xFF16221A),
            bgRaised2: const Color(0xFF213227),
            border: const Color(0xFF324A3B),
            navBg: const Color(0xD90B110D),
            accent: const Color(0xFF66BB6A),
            accentSoft: const Color(0x2966BB6A),
            brass: const Color(0xFF81C784),
          ),
        'gray' => dark.copyWith(
            pageBg: const Color(0xFF080808),
            bg: const Color(0xFF0A0A0A),
            bgRaised: const Color(0xFF181818),
            bgRaised2: const Color(0xFF262626),
            border: const Color(0xFF383838),
            navBg: const Color(0xD90A0A0A),
  ...
  static GymColors lightWith([String uiColor = 'default']) => switch (uiColor) {
        'violet' => light.copyWith(
            pageBg: const Color(0xFFFAF9FD),
            bg: const Color(0xFFF4F1F9),
            bgRaised: const Color(0xFFFFFFFF),
            bgRaised2: const Color(0xFFE9E4F3),
            border: const Color(0xFFDCD6EA),
            navBg: const Color(0xF2FAF9FD),
            text: const Color(0xFF191424),
            textSecondary: const Color(0xFF5D546F),
            textTertiary: const Color(0xFF887D9E),
            accent: const Color(0xFF7C4DFF),
            accentSoft: const Color(0x1F7C4DFF),
            brass: const Color(0xFF8E24AA),
            mutedFill: const Color(0xFFEBE6F5),
            heatEmpty: const Color(0xFFE7E1F2),
          ),
        'green' => light.copyWith(
            pageBg: const Color(0xFFF9FCFA),
            bg: const Color(0xFFF1F7F3),
            bgRaised: const Color(0xFFFFFFFF),
            bgRaised2: const Color(0xFFE2EFE5),
            border: const Color(0xFFD4E5D8),
            navBg: const Color(0xF2F9FCFA),
            text: const Color(0xFF111E15),
            textSecondary: const Color(0xFF4C6353),
            textTertiary: const Color(0xFF748F7C),
            accent: const Color(0xFF2E7D32),
            accentSoft: const Color(0x1F2E7D32),
            brass: const Color(0xFF388E3C),
            mutedFill: const Color(0xFFE3EFE6),
            heatEmpty: const Color(0xFFDFECE3),
          ),
        'gray' => light.copyWith(
            pageBg: const Color(0xFFFAFAFA),
            bg: const Color(0xFFF2F2F2),
            bgRaised: const Color(0xFFFFFFFF),
            bgRaised2: const Color(0xFFE4E4E4),
            border: const Color(0xFFD6D6D6),
            navBg: const Color(0xF2FAFAFA),
            ...
            mutedFill: const Color(0xFFE5E5E5),
            heatEmpty: const Color(0xFFE0E0E0),
          ),
        _ => light,
      };
